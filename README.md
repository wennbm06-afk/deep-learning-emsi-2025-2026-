...
II	Image	CNN (LeNet-Moderne) vs MLP baseline	Fashion-MNIST	CNN 90,64 % vs MLP 87,87 %
III	Séquentielle / Texte	Seq2Seq (LSTM bidirectionnel + attention Bahdanau)	Tatoeba (fra-eng, 30k paires)	Entraînement non finalisé (limite assumée)
